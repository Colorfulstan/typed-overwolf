...
import ODK = Overwolf
import InfoDB = Overwolf.GameEvents.LeagueOfLegends.InfoDB;
...
declare namespace Overwolf {
    ...
    namespace GameEvents {
        ...
        type TGameEventsInfo = { // TODO: generalize for more then league
            /** @see Overwolf.GameEvents.TFeatures */
            features: {[featureName: string]: Overwolf.TBuggedBoolean},
            /** @see Overwolf.GameEvents.LeagueOfLegends.GameInfo */
            game_info: {[featureName: string]: string | TODKNumericString | Overwolf.TBuggedBoolean},
            /** @see Overwolf.GameEvents.LeagueOfLegends.SummonerInfo */
            summoner_info: {[Key: string]: string}
        ...
        namespace LeagueOfLegends {
            ...
            interface GameInfo {
                ...
                /**
                 *  the level number of the player
                 *  @since Game Events Provider 0.19.0
                 */
                level?: TODKNumericString
            }
...
interface OverwolfGames {
    ...
    events: {
         ...
         * @updated 2016/12/20 Client v0.101.15
         * */
        getInfo(callback: (arg: ODKCallbackArg & {res: Overwolf.GameEvents.TGameEventsInfo, /** shown when status is "error" */ reason?: string}) => void)
        /**
    ...
    inputTracking: {
         ...
         * @since 0.78
         */
        onMouseUp: OverwolfListenable<{button: string, onGame: boolean, x:number, y:number}> /** TODO: typing button */
         ...
         * @since 0.78
         */
        onMouseDown: OverwolfListenable<{button: string, onGame: boolean, x:number, y:number}>
    }
